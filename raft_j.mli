...
val write_raft_persistent_state :
  Bi_outbuf.t -> raft_persistent_state -> unit
...
val raft_persistent_state_of_string :
  string -> raft_persistent_state
  (** Deserialize JSON data of type {!raft_persistent_state}. *)

val write_raft_mode :
  Bi_outbuf.t -> raft_mode -> unit
  (** Output a JSON value of type {!raft_mode}. *)

val string_of_raft_mode :
  ?len:int -> raft_mode -> string
...
val read_raft_mode :
  Yojson.Safe.lexer_state -> Lexing.lexbuf -> raft_mode
  (** Input JSON data of type {!raft_mode}. *)

val raft_mode_of_string :
  string -> raft_mode
  (** Deserialize JSON data of type {!raft_mode}. *)

val write_raft_state :
  Bi_outbuf.t -> raft_state -> unit
  (** Output a JSON value of type {!raft_state}. *)

val string_of_raft_state :
  ?len:int -> raft_state -> string
...
val read_raft_state :
  Yojson.Safe.lexer_state -> Lexing.lexbuf -> raft_state
  (** Input JSON data of type {!raft_state}. *)

val raft_state_of_string :
  string -> raft_state
  (** Deserialize JSON data of type {!raft_state}. *)

val write_raft_event :
  Bi_outbuf.t -> raft_event -> unit
  (** Output a JSON value of type {!raft_event}. *)

val string_of_raft_event :
  ?len:int -> raft_event -> string
...
val read_raft_event :
  Yojson.Safe.lexer_state -> Lexing.lexbuf -> raft_event
  (** Input JSON data of type {!raft_event}. *)

val raft_event_of_string :
  string -> raft_event
